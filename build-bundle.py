...
if platform.system() == "Windows":
    ...
    minecraft_launcher_lib_data = minecraft_launcher_lib_data.replace(":minecraft_launcher_lib", ";minecraft_launcher_lib")
...
if platform.system() == "Windows":
    ...
    customtkinter_data = customtkinter_data.replace(":customtkinter", ";customtkinter")
